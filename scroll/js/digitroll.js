...
DigitRoll.prototype={
    ...
    roll:function (n) {
        ...
        Array.prototype.forEach.call(this.container.querySelectorAll('.li-bg'), function (item,i) {
            ...
            setTimeout(function () {
                item.style.cssText+='-webkit-transition-duration:0.6s;-webkit-transform:translateY(-'+self.rollHeight*gapNum+'px)';
            },50)
        })
    },
    /** 
    ...
    setWidth:function (n) {
        ...
        var str='';
        for (var i=0; i<n; i++) {
            str+='<li class="li-bg" style="height:100%;line-height:'+this.rollHeight+'px"><div>0</div></li>';
        }
